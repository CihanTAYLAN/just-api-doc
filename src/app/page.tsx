...
export default function Home({ session }: HomeProps) {
  return (
    <div className="relative isolate bg-white dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-700 dark:text-gray-300">
            Build, manage, and share your API documentation with ease. Support for JSON format,
            custom styling, and secure access control.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            {session ? (
              <Link
                href="/dashboard"
                className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:hover:bg-indigo-400"
              >
                Go to Dashboard
              </Link>
            ) : (
      ...
      <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
            Features that make documentation easy
          </p>
        </div>
      ...
      {/* Footer */}
      <footer className="mt-32 sm:mt-40 border-t border-gray-200 dark:border-gray-800">
...
const features = [
  {
    name: 'JSON Support',
    description: 'Upload JSON files or provide URLs to automatically generate beautiful documentation.',
    icon: DocumentIcon,
  },
  {
    name: 'Access Control',
    description: 'Control who can view your documentation with public, private, and password-protected options.',
    icon: LockClosedIcon,
  },
  {
  ...
  {
    name: 'Easy Sharing',
    description: 'Share your documentation with a simple URL and optional access codes.',
    icon: ShareIcon,
  },
]
